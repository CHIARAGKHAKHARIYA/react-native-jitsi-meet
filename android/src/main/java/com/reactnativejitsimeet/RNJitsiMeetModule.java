            ...
            public void run() {
                if (mJitsiMeetViewReference.getJitsiMeetView() != null) {
                    ...
                    RNJitsiMeetConferenceOptions options = new RNJitsiMeetConferenceOptions.Builder()
                        ...
                        .setFeatureFlag("add-people.enabled", meetFeatureFlags.hasKey("addPeopleEnabled") ? false : true)
                        ...
                        .setFeatureFlag("invite.enabled", meetFeatureFlags.hasKey("inviteEnabled") ? false : true)
